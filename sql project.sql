...
select ENAME,ADDRESS,MERSRNO FROM EMPROYEE;

select ENAME,ADDRESS,MERSRNO FROM EMOROYEE;

select ENAME,ADDRESS,MERSRNO FROM EMPROYEE;

SELECT ENAME,ADDRESS,MERSRNO FROM EMPLOYEE;

SELECT ENAME,ADDRESS,MGRSRNO FROM EMPLOYEE;

SELECT ENAME,ADDRESS,MGRSRNO FROM EMPLOYEE E 
INNER JOIN  
DEPARTMENT D 
E.MGRSRNO=D.MGRSRNO;
...
SELECT ENAME,ADDRESS,MGRSRNO FROM EMPLOYEE d 
LEFT JOIN DEPARTMENT i 
ON E.MGRSRNO=D.MGRSRNO;

SELECT ENAME,ADDRESS,MGRSRNO FROM EMPLOYEE d 
LEFT JOIN DEPARTMENT i 
ON d.MGRSRNO=i.MGRSRNO;

SELECT ENAME,ADDRESS,MGRSRNO FROM EMPLOYEE d 
innerJOIN DEPARTMENT i 
ON d.MGRSRNO=i.MGRSRNO;

SELECT ENAME,ADDRESS,MGRSRNO FROM EMPLOYEE d 
inner JOIN DEPARTMENT i 
ON d.MGRSRNO=i.MGRSRNO;

SELECT ENAME,ADDRESS,MGRSRNO FROM EMPLOYEE d 
inner JOIN DEPARTMENT i 
ON i.MGRSRNO=d.MGRSRNO;
...
SELECT dname,dnumber,mgrsrno FROM department d 
inner JOIN employee i 
ON i.MGRSRNO=d.MGRSRNO;
...
SELECT DNAME,DNUMBER FROM DEPARTMENT d,EMPLOYEE i 
inner JOIN  
ON i.MGRSRNO=d.MGRSRNO;
...
SELECT DNAME,DNUMBER FROM DEPARTMENT d 
inner JOIN ENAME FROM EMPLOYEE i 
    ON 
 i.MGRSRNO=d.MGRSRNO;

SELECT DNAME,DNUMBER FROM DEPARTMENT d 
inner JOIN (SELECT ENAME FROM EMPLOYEE i) 
    EMPLOYEE i 
    ON 
 i.MGRSRNO=d.MGRSRNO;

SELECT DNAME,DNUMBER FROM DEPARTMENT d 
inner JOIN (SELECT ENAME FROM EMPLOYEE i)EMPLOYEE i 
    ON i.MGRSRNO=d.MGRSRNO;

SELECT DNAME,DNUMBER FROM DEPARTMENT d 
inner JOIN (SELECT ENAME FROM EMPLOYEE)EMPLOYEE i 
    ON i.MGRSRNO=d.MGRSRNO;
...
SELECT DNAME,DNUMBER,ename FROM DEPARTMENT d,employee i 
inner JOIN EMPLOYEE i 
    ON i.MGRSRNO=d.MGRSRNO;
...
SELECT DNAME,DNUMBER,ENAME.ADRESS FROM DEPARTMENT d,EMPLOYEE i 
inner JOIN EMPLOYEE i 
    ON i.MGRSRNO=d.MGRSRNO;

SELECT DNAME,DNUMBER,ENAME,ADRESS FROM DEPARTMENT d,EMPLOYEE i 
FULL OUTER JOIN EMPLOYEE i 
    ON i.MGRSRNO=d.MGRSRNO;
...
SELECT DNAME,DNUMBER,ENAME,ADDRESS FROM DEPARTMENT d 
INNER JOIN EMPLOYEE i 
    ON i.MGRSRNO=d.MGRSRNO;

SELECT ENAME,ADDRESS,DNAME,DNUMBER FROM DEPARTMENT d 
INNER JOIN EMPLOYEE i 
    ON i.MGRSRNO=d.MGRSRNO;

SELECT * FROM DEPARTMENT 
WHERE DNAME IS NOT 'ACDEMIC%';

SELECT * FROM DEPARTMENT 
WHERE DNAME LIKE 'ACDEMIC%';

SELECT * FROM DEPARTMENT 
WHERE DNAME LIKE 'ACADEMIC%';

SELECT * FROM DEPARTMENT 
WHERE DNAME NOT LIKE 'ACADEMIC%';

SELECT DNAME,ENAME FROM DEPARTMENT D 
    INNER JOIN EMPLOYEE I 
    ON i.MGRSRNO=d.MGRSRNO 
WHERE DNAME NOT LIKE 'ACADEMIC%';

SELECT ENAME,DNAME FROM DEPARTMENT D 
    INNER JOIN EMPLOYEE I 
    ON i.MGRSRNO=d.MGRSRNO 
WHERE DNAME NOT LIKE 'ACADEMIC%';

SELECT ENAME FROM EMPLOYEE I 
INNER JOIN Dept_locations D 
ON I.DNO=D.DNO 
WHERE ENAME LIKE 'SATYA%';

SELECT ENAME,DLOCATION,DNUMBER FROM EMPLOYEE I 
FULL OUTER JOIN Dept_locations D 
WHERE ENAME LIKE 'SATYA%';
...
SELECT * FROM Dept_locations D 
FULL OUTER JOIN EMPLOYEE I 
ON D.MGRSRNO=I.MGRSRNO  
WHERE ENAME LIKE 'SATYA%';

SELECT ENAME,DLOCATION,DNUMBER FROM Dept_locations D 
FULL OUTER JOIN EMPLOYEE I 
ON D.MGRSRNO=I.MGRSRNO  
WHERE ENAME LIKE 'SATYA%';
...
SELECT ENAME,DLOCATION FROM Dept_locations D 
FULL OUTER JOIN EMPLOYEE I 
ON D.MGRSRNO=I.MGRSRNO  
WHERE ENAME LIKE 'SATYA%';
...
SELECT ENAME,SEX,HOURS FROM Works_on I 
...
full outer join EMPLOYEE I 
ON DNO=I.DNO 
WHERE DLOCATION LIKE 'SOUTH AFRICA';

SELECT DLOCATION FROM Dept_locations D 
full outer join EMPLOYEE I 
ON DNO=I.DNO 
WHERE DLOCATION LIKE 'SOUTH AFRICA';
